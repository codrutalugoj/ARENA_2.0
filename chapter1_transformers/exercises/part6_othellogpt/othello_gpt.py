...
after_1st = logits[0, 0].log_softmax(-1)[1:]
board_state_after_1st = t.zeros((8, 8), dtype=t.float32, device=device) - 13.
board_state_after_1st.flatten()[stoi_indices] = after_1st

plot_square_as_board(board_state_after_1st.reshape(8, 8), diverging_scale=False, title="Example Log Probs")
...
# %% 
# Some random example of how the probe works:
layer = 6
game_index = 0
move = 29
...
# %%
# compare preds (probe_out_value) to ground truth
